...
function displayHero() {
  ...
  // const getImageAltText = localStorage.getItem("Helt");
  // const imageAltText = JSON.parse(getImageAltText);

  // const chosenHeroImage = heroImageMap[imageAltText];
...
function fight () {
  ...
  if (hero.HP > chosenEnemy.HP) {
    result.textContent = results[0];
  }
  else if (chosenEnemy.HP > hero.HP) {
    result.textContent = results[1];
  }
  else if (hero.HP = chosenEnemy.HP) {
